...
import { Content, Aside, Title, Arrow } from "./style";

export default function Template({ children }: { children: React.ReactNode }) {
  return (
    <Content className="h-screen w-full flex content-stretch">
      <Aside className="w-1/3 justify-center items-end flex-col flex">
        ...
        <Arrow width="213" height="213" viewBox="0 0 213 213" fill="none" xmlns="http://www.w3.org/2000/svg">
