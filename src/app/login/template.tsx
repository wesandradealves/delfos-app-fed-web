"use client";
import { Aside, Title, Arrow, Content } from "./style";

export default function Template({ children }: { children: React.ReactNode }) {
    return (
        <Content className="flex h-full w-full items-stretch">
            <Aside className="hidden md:flex w-1/2 xl:w-1/3 justify-center items-end flex-col">
                ...
                <Arrow className="hidden 2xl:block" width="213" height="213" viewBox="0 0 213 213" fill="none" xmlns="http://www.w3.org/2000/svg">
